...
//Basicamente este script es parte de un plugin de Unity, es automatico su funcionamiento
public class ShareScreenShot : MonoBehaviour
{
	...
	private IEnumerator TakeScreenshotAndShare()
	{
		...
		new NativeShare().AddFile(filePath)
			.SetSubject("Subject goes here").SetText("Quieres conocer mas sobre nuestro proyecto?")
